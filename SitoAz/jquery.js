$(document).ready(function() {
    $("#demo").textillate();
    $("#demo2").textillate();
    $("#maincontenuto").css('background-image','url(sn2.png)');
...
$("#begin").mouseover(function(){
    ...
    $("#maincontenuto").css('background-image','url(sn.png)');
});
...
$("#testo").mouseover(function(){
    $('#maincontenuto3').css ('background-image','url(sn.png)');
});
$("#testo").mouseleave(function(){
    $('#maincontenuto3').css ('background-image','url(sn2.png)');
});
...
$(document).on('mouseover', '.palla', function(){
     $('#bg').css ('background-image','url(sn.png)')
...
$(document).on('mouseleave', '.palla', function(){
         ...
         $('#maincontenuto3').css ('background-image','url(sn2.png)');
        $('#bg').css ('background-image','url(sn2.png)');
});
